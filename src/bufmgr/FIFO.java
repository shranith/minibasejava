...
class FIFO extends  Replacer {
  ...
  /**
   * This pushes the given frame to the end of the list.As in the FIFO algorithm the next page should be added is to the last, then the frame which is picked 
...
/* public methods */
	...
	PagePinnedException
 {
   ...
   int frame;
    ...
    for ( int i = 0; i < numBuffers; i = i+1 ) {
         frame = frames[i];
